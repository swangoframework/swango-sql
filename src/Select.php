...
class Select extends AbstractSql {
    ...
    const TAIL = 'tail';
    const TAIL_FOR_UPDATE = 'FOR UPDATE';
    const TAIL_LOCK_IN_SHARE_MODE = 'LOCK IN SHARE MODE';
    /**
     * #@-
     */
    ...
    protected array $specifications = [
        ...
        self::FORCE_INDEX => 'FORCE INDEX ( %1$s )',
        self::JOINS => [
            '%1$s' => [
                [
     ...
     * @throws Exception\InvalidArgumentException
     */
    public function tail(string $tail): self {
        $this->tail = $tail;
        return $this;
    }
    /**
    ...
    protected function resolveTable(array|string|TableIdentifier|Select $table, PlatformInterface $platform): string|array {
        ...
        $table = parent::resolveTable($table, $platform);
